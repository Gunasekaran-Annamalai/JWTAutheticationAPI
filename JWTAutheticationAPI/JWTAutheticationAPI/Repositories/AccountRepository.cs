...
namespace JWTAutheticationAPI.Repositories
{
        ...
        IConfiguration config) : IUserAccount
    {
        public async Task<GeneralResponse> CreateAccount(UserDTO userDTO)
        {
            ...
            if (!createUser.Succeeded) return new GeneralResponse(false, "Error occured... please try later");
        ...
        public async Task<LoginResponse> LoginAccount(LoginDTO loginDTO)
        {
            ...
            if (!checkUserPassword)
                return new LoginResponse(false, null!, "Invvalid username/password");
